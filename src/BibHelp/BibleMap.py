...
class BookNameManager:
    ...
    all_books = [
        ...
        BookName(['1 Царств', '1-я Царств', 'Первая книга Царств [Первая Самуила]', 'Первая книга Царств'], '1 Царств',
                 '1SA'),
        BookName(['2 Царств', '2-я Царств', 'Вторая книга Царств [Вторая Самуила]', 'Вторая книга Царств'], '2 Царств',
                 '2SA'),
        BookName(['3 Царств', '3-я Царств', 'Третья книга Царств [Первая Царей]', 'Третья книга Царств'], '3 Царств',
                 '1KI'),
        ...
        BookName(['К Римлянам', 'Послание к Римлянам святого апостола Павла', 'Послание к Римлянам'], 'К Римлянам',
                 'ROM'),
        ...
        BookName(['2 Коринфянам', '2-е Коринфянам', 'Второе послание к Коринфянам святого апостола Павла',
                 ...
                 '2 Коринфянам',
                 '2CO'),
        BookName(['К Галатам', 'Послание к Галатам святого апостоля Павла', 'Послание к Галатам'], 'К Галатам', 'GAL'),
        BookName(['К Ефесянам', 'Послание к Ефесянам святого апостола Павла', 'Послание к Ефесянам'], 'К Ефесянам',
                 'EPH'),
        ...
        BookName(['1 Фессалоникийцам', '1-е Фессалоникийцам',
                  ...
                  'Первое послание к Фессалоникийцам...', 'Первое послание к Фессалоникийцам'], '1 Фессалоникийцам',
                 '1TH'),
        BookName(['2 Фессалоникийцам', '2-е Фессалоникийцам',
                  'Второе послание к Фессалоникийцам (Солунянам) святого апостола Павла',
                  'Второе послание к Фессалоникийцам...', 'Второе послание к Фессалоникийцам'], '2 Фессалоникийцам',
                 '2TH'),
        BookName(['1 Тимофею', '1-е Тимофею', 'Первое послание к Тимофею святого апостола Павла',
                  'Первое послание к Тимофею'], '1 Тимофею',
                 '1TI'),
        BookName(['2 Тимофею', '2-е Тимофею', 'Второе послание к Тимофею святого апостола Павла',
                  'Второе послание к Тимофею'], '2 Тимофею',
                 '2TI'),
        BookName(['К Титу', 'Послание к Титу святого апостола Павла', 'Послание к Титу'], 'К Титу', 'TIT'),
        BookName(['К Филимону', 'Послание к Филимону святого апостола Павла', 'Послание к Филимону'], 'К Филимону',
                 'PHM'),
        BookName(['К Евреям', 'Послание к Евреям святого апостола Павла', 'Послание к Евреям'], 'К Евреям', 'HEB'),
