...
from src.BibHelp.BibleMap import BIBLE_BOOKS_RU_EN_MAP
...
class USXDumper(AbstractDump):
    ...
    def dump(self, path: str):
        ...
        for book in all_books:
            ...
            path_to_file = os.path.join(path, alias + AbstractUSXWriter.USX_EXTENSION)

            with open(path_to_file, 'w') as file:
                file.write(self.usx_writer.start_book(alias, book.name))
                ...
                file.write(self.usx_writer.end_book(alias, book.name))
